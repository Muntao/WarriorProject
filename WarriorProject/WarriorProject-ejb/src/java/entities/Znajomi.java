...
@NamedQueries({
    ...
    @NamedQuery(name = "Znajomi.findByZnajomiKlientId", query = "SELECT z FROM Znajomi z WHERE z.znajomiKlientIdFk.klientId = :klientId OR z.znajomiKlient2IdFk.klientId = :klientId")})
